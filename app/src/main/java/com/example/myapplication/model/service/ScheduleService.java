...
import com.example.myapplication.model.DataApi;
...
public class ScheduleService {
    ...
    private static ScheduleService instance;//todo
    ...
    public static ScheduleService getInstance() { // getInstance 호출 시 본인 객체를 반환하며 api 서버 객체를 생성한다.
        if (instance == null) {
    ...
    public Single<UserData> GetData(String userId, String userPw) {
        return api.GetData(userId, userPw);
    }
}
